        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-gray-900">{currentContent.companyName}</h1>
              <p className="text-xs text-gray-600">{currentContent.companySubtitle}</p>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-3">
              ...
              >
                ...
                <span className="text-sm font-medium">{currentContent.callNow}</span>
              </a>
              <a
          ...
          <div className="lg:hidden border-t border-gray-200 py-4">
            ...
            <div className="flex flex-col space-y-3 pt-4 border-t border-gray-200 mt-4">
              ...
              >
                ...
                <span className="font-medium">{currentContent.callNow}</span>
              </a>
              <a
                href="https://wa.me/971588595161"
                target="_blank"
